...
subfig = make_subplots(
    rows=1, cols=2,
    column_widths=[0.75, 0.25],  # Drug chart wider than poverty bar
    specs=[[{"type": "xy"}, {"type": "xy"}]],
    subplot_titles=["Substance Use by Age Group Across the US", "US Poverty Rates"]
)
...
subfig.add_trace(
    go.Bar(x=poverty_data[["total_pov","child_pov"]], y=poverty_data[["total_pov","child_pov"]], marker_color="crimson"),
    row=1, col=2
)
